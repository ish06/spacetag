...
const Matrix = tiny.Matrix =
    class Matrix extends Array {
        ...
        //  "M.sub_block( host, end )" where host and end are each a [ row, column ] pair returns a sub-rectangle cut out from M.
...
const Graphics_Card_Object = tiny.Graphics_Card_Object =
    class Graphics_Card_Object {
        ...
        copy_onto_graphics_card(context, intial_gpu_representation) {
            ...
            return existing_instance ||             // If necessary, host a new object associated with the context.
